...
var e=require("./utils").default,t=e.logger,n=require("./api"),o=n.RouteTo,s="urn:xmpp:media-conference",d={_apiCallbacks:{},imConnection:null,_connectedSid:"",init:function(){var e=this;e.imConnection.registerConfrIQHandler=function(n,o,s){try{e.handleRtcMessage(n)}catch(d){t.error(d)}}},handleRtcMessage:function(n,s,d){var a=this;if(n){var i=WebIM.conn.context.root.lookup("easemob.pb.ConferenceBody").decode(n.payload),r=(n.id,n.from.name||"");r.lastIndexOf("/")>=0&&(r=r.substring(0,r.lastIndexOf("/")));var c=i.routeKey,p=i.sessionId;(a._fromSessionID||(a._fromSessionID={}))[r]=p;var f=e.parseJSON(i.content),y=f,l=1==i.type?"VIDEO":"VOICE";""==l&&(l="VOICE"),y.streamType=l,102==y.op&&(a.singalStreamType=l);var m=f.tsxId;if(a.ctx=f.ctx,t.debug("Recv [op = "+y.op+"] [tsxId="+m+"]\r\n json :",n),""!=a._connectedSid||0!=y.result&&102!=y.op&&202!=y.op){if(a._connectedSid!=p){if(t.debug("Error recv [op = "+y.op+"] [tsxId="+m+"]. caused by _connectedSid != fromSessionId :",a._connectedSid,p),102==y.op&&p&&a._connectedSid){var g=new o({to:r,rtKey:c,sid:p,success:function(e){t.debug("iq to server success",e)},fail:function(e){t.debug("iq to server error",e),a.onError(e)}}),u={data:{op:107,sessId:y.sessId,rtcId:y.rtcId,reason:"busy"},reason:"busy"};a.sendRtcMessage(g,u)}return}}else a._connectedSid=p;if(107==y.op){a._connectedSid="",_fromSessionID={};var v=i.endReason;y.reason=null!=v&&{0:"hangup",1:"noresponse",2:"reject",3:"busy",4:"fail",5:"unsupported",6:"offline"}[v]}if(y.sdp&&("string"==typeof y.sdp&&(y.sdp=e.parseJSON(y.sdp)),y.sdp.type&&(y.sdp.type=y.sdp.type.toLowerCase())),y.cands){"string"==typeof y.cands&&(y.cands=e.parseJSON(y.cands));for(var I=0;I<y.cands.length;I++){if("string"==typeof y.cands[I])try{y.cands[I]=e.parseJSON(y.cands[I])}catch(S){y.cands[I]={candidate:y.cands[I]}}y.cands[I].sdpMLineIndex=void 0!==y.cands[I].sdpMLineIndex?y.cands[I].sdpMLineIndex:y.cands[I].mlineindex,y.cands[I].sdpMid=void 0!==y.cands[I].sdpMid?y.cands[I].sdpMid:y.cands[I].mid,delete y.cands[I].mlineindex,delete y.cands[I].mid}}if(y.rtcCfg&&"string"==typeof y.rtcCfg&&(y.rtcCfg=e.parseJSON(y.rtcCfg)),y.rtcCfg2&&"string"==typeof y.rtcCfg2&&(y.rtcCfg2=e.parseJSON(y.rtcCfg2)),y.WebRTC&&"string"==typeof y.WebRTC&&(y.WebRTC=e.parseJSON(y.WebRTC)),y.confrId&&(y.conferenceId=y.confrId),m&&a._apiCallbacks[m])try{a._apiCallbacks[m].callback&&a._apiCallbacks[m].callback(r,y)}catch(b){throw b}finally{delete a._apiCallbacks[m]}else a.onRecvRtcMessage(r,y,c,m,p);return!0}},onRecvRtcMessage:function(n,o,s,d,a){t.debug(" form : "+n+" \r\n json :"+e.stringifyJSON(rtcJSON))},convertRtcOptions:function(t){var n=t.data.sdp;n&&((n={type:n.type,sdp:n.sdp}).type=n.type.toUpperCase(),n=e.stringifyJSON(n),t.data.sdp=n);var o=t.data.cands;if(o){if(e.isArray(o));else{var s=[];s.push(o),o=s}for(var d in o){var a=o[d];if(void 0!==a.candidate&&void 0!==a.sdpMLineIndex&&void 0!==a.sdpMid){var i={type:"candidate",candidate:a.candidate,mlineindex:a.sdpMLineIndex,mid:a.sdpMid};o[d]=e.stringifyJSON(i)}}t.data.cands=o}var r=t.data.rtcCfg;r&&"string"!=typeof r&&(t.data.rtcCfg=e.stringifyJSON(r));var c=t.data.WebRTC;c&&"string"!=typeof c&&(t.data.WebRTC=e.stringifyJSON(c))},getShortId:function(e){var t,n;return(t=e.indexOf("_")+1)<1&&(t=0),(n=e.indexOf("@",-1))<0&&(n=e.length),e.substring(t,n)},sendRtcMessage:function(t,n,o){var s=this.imConnection,d=s.getUniqueId(),a=t.to&&t.to||s.domain;if(a.indexOf("@")>=0){var i=a.split("_");i.splice(0,1),a=i.join("_").split("@")[0],""==this._connectedSid&&102==n.data.op&&(this._connectedSid=r)}var r=t.sid||this._fromSessionID&&this._fromSessionID[a];r=r||((this._fromSessionID||(this._fromSessionID={}))[a]=s.getUniqueId("CONFR_")),(this._fromSessionID||(this._fromSessionID={}))[a]=r;var c=t.rtKey||t.rtkey;c||(c="");var p=t.rtflag;!isNaN(p)||(p=1),n.data||(n.data={}),n.data.tsxId=d,this.ctx&&(n.data.ctx=this.ctx),this.convertRtcOptions(n);var f=n.streamType||this.singalStreamType||"VIDEO";102==n.data.op&&(this.singalStreamType=f);var y=t.id||s.getUniqueId("CONFR_");o&&(this._apiCallbacks[d]={callback:o});var l={id:y,to:a,from:s.context.jid,type:"VIDEO"==f?1:0,rtflag:p,stream_type:f,sid:r,content:n.data,reason:n.reason,rtKey:c};if(202!=n.data.op&&this._sendMessage(l,WebIM.conn),107==n.data.op&&this._connectedSid&&(t.sid&&this._connectedSid!=t.sid||(this._connectedSid="",this._fromSessionID={})),202==n.data.op){var m=e.list("Invite",this.getShortId(a),"join conference:",n.data.confrId).join(" "),g={msg:m,id:y=s.getUniqueId("CONFR_INVITE"),to:a,from:s.context.jid,contents:[{contenttype:"TEXT",text:m}],gid:n.data.gid,password:n.data.password,exts:{key:"conferenceId",type:7,value:n.data.confrId}};return this._sendGroupInviteMsg(g,WebIM.conn)}},_sendGroupInviteMsg:function(e,t){var n=[],o=t.context.root.lookup("easemob.pb.MessageBody.Content").decode(n);o.type=0,o.text=e.msg;var s=t.context.root.lookup("easemob.pb.MessageBody"),d=s.decode(n);d.from={name:e.from.name},d.to={name:e.to},d.contents=[o];var a=t.context.root.lookup("easemob.pb.KeyValue"),i=a.decode(n),r=a.decode(n),c=a.decode(n);i.key="conferenceId",i.type=7,i.stringValue=e.exts.value,r.key="msg_extension",r.type=7,r.stringValue=JSON.stringify({inviter:e.from.name,group_id:e.gid}),c.key="password",c.type=7,c.stringValue=e.password,d.ext=[i,r,c],d.type=1,d=s.encode(d).finish();var p=t.context.root.lookup("easemob.pb.Meta").decode(n);p.id=e.id,p.from=e.from,p.to={appKey:t.appKey,name:e.to,domain:"easemob.com"},p.ns=1,p.type=1,p.payload=d;var f=t.context.root.lookup("easemob.pb.CommSyncUL"),y=f.decode(n);y.meta=p,y=f.encode(y).finish();var l=t.context.root.lookup("easemob.pb.MSync"),m=l.decode(n);m.version=t.version,m.encryptType=t.encryptType,m.command=0,m.guid=t.context.jid,m.payload=y,m=l.encode(m).finish(),t.sendMSync(m)},_sendMessage:function(e,t){var n,o=[],s=t.context.root.lookup("easemob.pb.ConferenceBody"),d=s.decode(o);e.content.video;0==e.content.op?n={op:e.content.op,callVersion:"2.0.0",audio:e.content.audio,video:e.content.video,tsxId:String(e.content.tsxId),peer:e.content.peer+"/",push:0}:400==e.content.op?n=e.content:(n=e.content).tsxId=String(e.content.tsxId);var a=e.content.op;if(d.content=JSON.stringify(n),d.routeFlag=e.rtflag,d.operation=7,d.sessionId=String(e.sid),d.type=e.type,102!=a&&104!=a&&105!=a&&107!=a&&400!=a||(d.routeKey=e.rtKey,d.routeFlag=e.rtflag,d.peerName=e.from.name),107==a){d.endReason={success:0,ok:0,timeout:1,decline:2,busy:3,"failed-transport":4,unsupported:5,offline:6}[e.reason]}d=s.encode(d).finish();var i=t.context.root.lookup("easemob.pb.Meta").decode(o);i.id=String(e.id),i.ns=4,i.to={appKey:e.from.appKey,domain:e.from.domain,name:e.to},102==e.content.op&&(i.from=e.from),i.payload=d;var r=t.context.root.lookup("easemob.pb.CommSyncUL"),c=r.decode(o);c.meta=i,c=r.encode(c).finish();var p=t.context.root.lookup("easemob.pb.MSync"),f=p.decode(o);f.version=t.version,f.encryptType=t.encryptType,f.command=0,f.guid=t.context.jid,f.payload=c,f=p.encode(f).finish(),t.sendMSync(f)}},a=function(t){e.extend(!0,this,d,t||{}),this.init()};module.exports=a;
